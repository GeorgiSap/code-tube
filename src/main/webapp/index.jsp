		...
		<div class="main-grids">
			<div class="top-grids">
				...
				<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
					...
					<div class="resent-grid-info recommended-grid-info">
						<h3>
							<a href="single.html" class="title title-info">Interdum
				...
				<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
					...
					<div class="resent-grid-info recommended-grid-info">
						<h3>
							<a href="single.html" class="title title-info">Nullam
				...
				<div class="recommended-grids">
					...
					<div class="col-md-3 resent-grid recommended-grid">
						...
						<div
							class="resent-grid-info recommended-grid-info video-info-grid">
							<h5>
								<a href="single.html" class="title">Nullam interdum viverra
									nullam metus varius sit sed viverra</a>
							</h5>
							<ul>
								<li><p class="author author-info">
										<a href="#" class="author">John Maniya</a>
